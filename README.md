...
![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/1.1.png) 

  tr [:upper:] [:lower:] < article.txt > lowercase.txt
  tr -cd ’[a-z][\n][:space:]’ < lowercase.txt > plaintext.txt

![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/1.2.png)
...
![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/1.3.png)
...
![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/1.4.png)
...
![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/2.1.png)
...
![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/2.2.png)
...
![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/2.3.png)
...
![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/3.1.png)
...
-K 00112233445566778889aabbccddeeff
ls -ld ecb_out.bin 
![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/4.1.png)
...
![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/4.2.png)          
...
-iv 0102030405060708
ls -ld cfb_out.bin #5
![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/4.3.png)
...
![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/4.4.png)
...
![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/4.5.png)

openssl enc  -aes-128-ecb  -e -in big_file.txt -out big_out.bin \
-K 00112233445566778889aabbccddeeff 

![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/4.6.png)

openssl enc  -aes-128-ecb  -d -in big_out.bin -out decrypted.txt \
-K 00112233445566778889aabbccddeeff 

![alt tag](https://github.com/Manan-GitHub/Secret-Key-Encryption-Lab/blob/main/4.7.png)
